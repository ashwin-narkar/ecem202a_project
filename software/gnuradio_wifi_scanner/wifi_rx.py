...
import ieee802_11
import threading
import wifi_rx_pymod as pymod  # embedded python module
...
class wifi_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.gain = gain = 0.75
        self.freq = freq = pymod.sweepFreqs()
        ...
        self._samp_rate_options = [5000000.0, 10000000.0, 20000000.0, 40000000.0]
