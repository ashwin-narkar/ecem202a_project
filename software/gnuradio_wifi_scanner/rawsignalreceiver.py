...
class rawsignalreceiver(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "rawsignalreceiver")
        ...
        self.gain = gain = 0.75
        self.freq = freq = 5190000000.0
        self.enableCollection = enableCollection = 1
        ...
        _enableCollection_check_box = Qt.QCheckBox('WriteToFile?')
        self._enableCollection_choices = {True: 0, False: 1}
        self._enableCollection_choices_inv = dict((v,k) for k,v in self._enableCollection_choices.items())
        self._enableCollection_callback = lambda i: Qt.QMetaObject.invokeMethod(_enableCollection_check_box, "setChecked", Qt.Q_ARG("bool", self._enableCollection_choices_inv[i]))
        self._enableCollection_callback(self.enableCollection)
        _enableCollection_check_box.stateChanged.connect(lambda i: self.set_enableCollection(self._enableCollection_choices[bool(i)]))
        self.top_layout.addWidget(_enableCollection_check_box)
        ...
        # Create the options list
        self._samp_rate_0_options = [5000000.0, 10000000.0, 20000000.0, 40000000.0]
        # Create the labels list
        self._samp_rate_0_labels = ['5 MHz', '10 MHz', '20 MHz', '40 MHz']
        # Create the combo box
        ...
        self.blocks_selector_0 = blocks.selector(gr.sizeof_gr_complex*1,0,enableCollection)
        self.blocks_selector_0.set_enabled(True)
        self.blocks_null_sink_0 = blocks.null_sink(gr.sizeof_gr_complex*1)
        self.blocks_file_sink_1 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/ashwin/Documents/EEM202/ecem202a_project/software/gnuradio_wifi_scanner/receivedSignal.bin', False)
    ...
    def get_enableCollection(self):
        return self.enableCollection

    def set_enableCollection(self, enableCollection):
        self.enableCollection = enableCollection
        self._enableCollection_callback(self.enableCollection)
        self.blocks_selector_0.set_output_index(self.enableCollection)
...
def main(top_block_cls=rawsignalreceiver, options=None):
