...
class WifiScanner(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.uhd_usrp_source_0.set_bandwidth(50e6, 0)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate*2, analog.GR_COS_WAVE, -samp_rate/2, 1, 0, 0)
    ...
    def set_freq(self, freq):
        self.freq = freq
        self._freq_callback(self.freq)
        self.qtgui_freq_sink_x_0.set_frequency_range(self.freq, 50e6)
